...
**Overview:**
This project implements a simple control loop that samples an analog input, applies basic digital filtering, and drives a PWM output, all while operating with non-blocking delays.
